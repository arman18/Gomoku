...
double utility(int **gameState, int x, int y)
{
    ...
    double profit[] = {200000000.0, 50000.0, 15000.0, 15000.0, 480.0, 420.0, 350.0, 350.0, 200.0, 150.0,
                        50.0, 20.0, 10.0, 10.0, 10.0, 10.0, 10.0, 5.0, 5.0, 1.0};
